...
convert -background none "$ROOT/public/favicon.svg" -define icon:auto-resize=256,128,64,48,32,16 "$ROOT/public/favicon.ico"
echo "Wrote icons to $OUT and public/favicon.ico"

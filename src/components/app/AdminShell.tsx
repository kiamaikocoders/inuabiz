...
const nav: NavItem[] = [
  ...
  { to: "/admin/unclaimed", label: "Unclaimed payments", icon: ShieldAlert },
  { to: "/admin/subscriptions", label: "Subscriptions & MRR", icon: Wallet },
...
function SidebarInner({ onNavigate }: { onNavigate?: (() => void) | undefined }) {
  ...
  return (
    <div className="flex h-full flex-col bg-sidebar py-5">
      ...
      <p className="px-5 pb-5 text-[11px] font-semibold tracking-widest text-sidebar-primary uppercase">
        Command Center
      </p>

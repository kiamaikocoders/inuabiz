...
export const Route = createFileRoute("/pricing")({
  head: () =>
    pageHead({
      ...
      description:
        "InuaBiz Standard per shop / month after a free trial, Compliance (ETR) when you need ETR-format receipts, assisted setup, and enterprise custom builds. Clear Kenya POS pricing.",
      path: "/pricing",
      ogTitle: "InuaBiz pricing — Standard, Compliance, Enterprise",
      ogDescription:
        "Self-serve till from admin-managed plan rates. ETR-format receipts, assisted setup and white-label enterprise — Nairobi team.",
      jsonLd: [
        breadcrumbJsonLd([
          { name: "InuaBiz", path: "/" },
...
const standardIncludes = [
  "Unlimited POS — cash, credit, M-Pesa",
...
const complianceIncludes = [
  ...
  "ETR-format receipts (control number, VAT split, QR)",
  "KRA PIN on the shop profile",
  "Records for your KRA filing pack — not live eTIMS",
  ...
  const faqs = useMemo(
    () => [
      ...
      },
      {
        ...
        a: `It is Standard plus ETR-format receipts (control number, VAT split, QR) for your KRA filing pack — generated by InuaBiz for forwarding and compliance records, not live eTIMS or OSCU. You can pick Compliance on the last onboarding step, or stay on Standard (${KES(shop)}) and upgrade later from Billing.`,
      },
      {
      ...
      },
      {
        ...
        a: "Not for Standard. Start with a personal M-Pesa number. The Compliance pack is for shops that already keep a KRA PIN and want ETR-format receipts for their filing pack.",
      },
      {
        ...
        <section className="relative overflow-hidden px-4 pb-16 pt-12 sm:px-6 lg:px-20">
          ...
          <div className="relative z-10 mx-auto mt-10 grid max-w-6xl items-stretch gap-5 lg:grid-cols-3">
            <PlanCard
              ...
              blurb="Standard plus ETR-format receipts for shops that already keep a KRA PIN — for your filing pack, not live eTIMS."
